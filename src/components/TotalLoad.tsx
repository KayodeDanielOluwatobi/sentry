        ...
        <div style={{ marginBottom: "0" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: "1rem", marginTop: "0.6rem" }}>
            <span style={{ fontSize: "2.5rem", fontWeight: 500, color: textColor, lineHeight: 1, letterSpacing: "0.01em", whiteSpace: "nowrap" }}>
              {currentWatts}<span style={{ fontSize: "1.2rem", fontWeight: 400, color: grayText, marginLeft: "0.2rem" }}>W</span>
            </span>
            <span style={{
              background: pillBg,
              color: statusColor,
              ...
              <motion.span
                ...
                style={{ 
                  ...
                  boxShadow: `0 0 6px 2px ${dotShadow}` 
                }}
              />
        ...
        <div style={{ 
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ 
              ...
              <TrendingUp size={12} strokeWidth={2} style={{ flexShrink: 0 }} />
              Peak load
            </div>
            <div style={{ fontSize: "1.05rem", fontWeight: 700, color: textColor, letterSpacing: "0.01em", whiteSpace: "nowrap" }}>
              {peakWatts}<span style={{ fontSize: "0.75rem", fontWeight: 400, color: grayText, marginLeft: "2px" }}>W</span>
            </div>
          </div>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: "1.05rem", fontWeight: 700, color: efficiency > 90 ? (isDark ? "#86efac" : "#16a34a") : "#f97316", letterSpacing: "0.01em", whiteSpace: "nowrap" }}>
              {efficiency}<span style={{ fontSize: "0.75rem", fontWeight: 400, color: grayText, marginLeft: "1px" }}>%</span>
            </div>
          </div>
        </div>
